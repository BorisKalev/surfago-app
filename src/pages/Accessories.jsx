...
import { HandleRopesInfo } from "../constants/index";
import { BootsInfo } from "../constants/index";
...
const Accessories = () => {
  ...
  const boards = [...HandleRopesInfo, ...BootsInfo];

  const allAccessories = sortItems(boards, sortOption);
